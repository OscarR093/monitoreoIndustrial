  ...
  return (
    <div className="rounded-xl bg-panel p-8 border border-gridline">
      <div className="mb-8 text-center">
        <Activity size={40} className="mx-auto text-acento mb-3" />
        <h1 className="font-mono text-2xl font-bold text-acento">Monitoreo Industrial</h1>
        <p className="mt-2 text-sm text-text-muted">Inicie sesión para acceder al sistema</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          <label htmlFor="login-username" className="block text-sm font-medium text-text-muted mb-1">Usuario</label>
        ...
        <div>
          <label htmlFor="login-password" className="block text-sm font-medium text-text-muted mb-1">Contraseña</label>
